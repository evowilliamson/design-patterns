...
public class BitmapStyleFactory extends BaseStyleFactory {
    ...
    BitmapStyleFactory() {
        ...
        styles.put(0, new BitmapStyle(0, 20));
        styles.put(1, new BitmapStyle(20, 10));
        styles.put(2, new BitmapStyle(50, 10));
        styles.put(3, new BitmapStyle(70, 10));
        styles.put(4, new BitmapStyle(90, 10));
    }
