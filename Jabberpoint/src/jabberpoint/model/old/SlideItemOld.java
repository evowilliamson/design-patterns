...
public abstract class SlideItemOld {
	private int level = 0; // het level van het slideitem

	public SlideItemOld(int lev) {
		level = lev;
	}
...
// Geef de bounding box
	public abstract Rectangle getBoundingBox(Graphics g, 
			ImageObserver observer, float scale, StyleOld style);

// teken het item
	public abstract void draw(int x, int y, float scale, 
			Graphics g, StyleOld style, ImageObserver observer);
}
